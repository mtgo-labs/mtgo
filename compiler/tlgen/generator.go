...
func GenerateE2EPackage(outDir string, combos []Combinator, layer int) error {
	...
	e2eRegistry := func() string {
		var buf strings.Builder
		buf.WriteString("// Code generated by tlgen. DO NOT EDIT.\n\npackage e2e\n\n")
		writeImports(&buf, "bytes", "encoding/binary", "io", "github.com/mtgo-labs/mtgo/tg")
	...
	for _, typeName := range typeOrder {
		...
		var buf strings.Builder
		buf.WriteString("// Code generated by tlgen. DO NOT EDIT.\n\npackage e2e\n\n")
		writeImports(&buf, "bytes", "io", "github.com/mtgo-labs/mtgo/tg")
