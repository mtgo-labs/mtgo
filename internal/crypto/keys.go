...
// ServerKey holds an RSA public key used to verify Telegram server responses.
...
func init() {
	serverPublicKeys[-5595554452916591101] = &ServerKey{
		N: newBigInt("C8C11D635691FAC091DD9489AEDCED2932AA8A0BCEFEF05FA800892D9B52ED032" +
			...
			"5B6584DB76FE8B1370263246C010C93D011014113EBDF987D093F9D37C2BE483" +
			"52D69A1683F8F6E6C2167983C761E3AB169FDE5DAAA12123FA1BEAB621E4DA5" +
			"935E9C198F82F35EAE583A99386D8110EA6BD1ABB0F568759F62694419EA5F69" +
			"847C43462ABEF858B4CB5EDC84E7B9226CD7BD7E183AA974A712C079DDE85B9D" +
			"C063B8A5C08E8F859C0EE5DCD824C7807F20153361A7F63CFD2A433A1BE7F5"),
		E: big.NewInt(65537),
	}
	...
	serverPublicKeys[-3414540481677951611] = &ServerKey{
		N: newBigInt("E8BB3305C0B52C6CF2AFDF7637313489E63E05268E5BADB601AF417786472E5" +
			...
			"0D9F7C2B7DEF99688BA3073ADB5750BB02964902A359FE745D8170E36876D4FD8" +
			"A5D41B2A76CBFF9A13267EB9580B2D06D10357448D20D9DA2191CB5D8C939829" +
			"61CDFDEDA629E37F1FB09A0722027696032FE61ED663DB7A37F6F263D370F69D" +
			"B53A0DC0A1748BDAAFF6209D5645485E6E001D1953255757E4B8E42813347B11D" +
			"A6AB500FD0ACE7E6DFA3736199CCAF9397ED0745A427DCFA6CD67BCB1ACFF3"),
		E: big.NewInt(65537),
	}
...
func newBigInt(hex string) *big.Int {
	...
	if !ok {
		panic("crypto/keys: invalid hex big integer")
	}
	return n
}
