...
//   - func(*Client, *types.MessageReactions): receives the client and the reaction counts
//   - func(*Context, *types.MessageReactions): receives both the context and the reaction counts
//
