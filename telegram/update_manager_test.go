...
func TestUpdateManagerDuplicateIgnored(t *testing.T) {
	mgr := testUpdateManager(t)
	mgr.state.Pts = 10
	err := mgr.applyUpdate(context.Background(), &tg.UpdateDeleteMessages{Messages: []int32{1}, PTS: 9, PTSCount: 1}, nil)
	if err != nil {
...
func TestLiveUpdateArrivingWhileRecoveryRunningDoesNotStartDuplicateRecovery(t *testing.T) {
	...
	mgr.state.Pts = 10
	mgr.recovering = true
	err := mgr.applyUpdate(context.Background(), &tg.UpdateDeleteMessages{Messages: []int32{1}, PTS: 12, PTSCount: 1}, nil)
	if err != nil {
...
func TestLiveGapRecoveryTriggersGetDifference(t *testing.T) {
	...
	err := mgr.applyUpdate(context.Background(), &tg.UpdateDeleteMessages{Messages: []int32{1}, PTS: 13, PTSCount: 1}, nil)
	if err != nil {
...
func TestUpdateChannelTooLongTriggersRecovery(t *testing.T) {
	...
	err := mgr.applyUpdate(context.Background(), &tg.UpdateChannelTooLong{ChannelID: 100}, nil)
	if err != nil {
